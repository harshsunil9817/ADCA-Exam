                    ...
                    <CardHeader className="text-center">
                        {user.photoUrl && (
                             <div className="flex justify-center items-center mb-4">
                                <Image
                                    src={user.photoUrl.startsWith('rec_') 
                                        ? `https://shiv-shakti-image-server.onrender.com/api/image/${user.photoUrl}?key=sec_wd7pgafk050flgve` 
                                        : user.photoUrl}
                                    alt="Student Photo"
                                    width={250}
                                    height={400}
                                    className="rounded-md border-4 border-primary object-cover"
                                    unoptimized={user.photoUrl.startsWith('rec_')}
                                />
                            </div>
                        )}
